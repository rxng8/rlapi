...
class MountainCarContinuous(gym.Env):
  ...
  * v0: Initial versions release (1.0.0)
  ...
  def __init__(self, render_mode: Optional[str] = None, goal_velocity=0, easy_mode=True, reward_shaping=False, freeze_when_done=True):
...
class MountainCarContinuousImageObservation(MountainCarContinuous):
  ...
  def __init__(self, render_mode=None, goal_velocity=0, easy_mode=True, reward_shaping=False, freeze_when_done=True):
